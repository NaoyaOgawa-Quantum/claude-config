...
2. SESSION.md が長くなっていたら棚卸し（上記「棚卸し」参照）
3. CLAUDE.md の更新が必要か判断（構造変更があった場合のみ）
4. CLAUDE.md を更新した場合 → CONVENTIONS.md と矛盾がないか確認
5. 冗長・陳腐化・曖昧な記述がないか確認
6. commit → push
```

軽微な変更（typo 等）で CLAUDE.md に影響がなければステップ 3-5 はスキップ可。
